    ...
    <AppLayout title="Dashboard" subtitle="Welcome back — here's your overview">
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
          ...
          <StatsCard onClick={() => navigate("/hr")} title="Team Members" value={stats.isLoading ? "—" : String(stats.activeMembers)} icon={Users} delay={150} />
          <StatsCard onClick={() => navigate("/invoices")} title="Revenue" value={stats.isLoading ? "—" : stats.totalRevenue} icon={DollarSign} delay={200} />
